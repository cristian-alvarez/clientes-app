/*
Esta clase utiliza un objeto httpHeaders y el método agregarAuthorizationHeader() para
insertar la cabecera en cada petición (Request), en el servicio cliente actualizado ya no se
incluyen, ahora todo es por interceptores (token y auth).
*/
